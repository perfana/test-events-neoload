...
@Schema(name = "EventPage", description = "Represents a page of Events.")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2024-04-06T15:29:22.895694+02:00[Europe/Amsterdam]", comments = "Generator version: 7.4.0")
public class EventPage {

  @Valid
  private List<@Valid Event> items = new ArrayList<>();
   ...
   */
  public EventPage(List<@Valid Event> items, Long total) {
    this.items = items;
    this.total = total;
  }

  public EventPage items(List<@Valid Event> items) {
    this.items = items;
    return this;
  }
  ...
  */
  ...
  @JsonProperty("items")
  public List<@Valid Event> getItems() {
    return items;
  }

  public void setItems(List<@Valid Event> items) {
    this.items = items;
  }

  public EventPage total(Long total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public EventPage pageNumber(Integer pageNumber) {
  ...
  */
  ...
  public EventPage pageSize(Integer pageSize) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, eventPage.items) &&
        ...
        Objects.equals(this.pageNumber, eventPage.pageNumber) &&
        Objects.equals(this.pageSize, eventPage.pageSize);
  }
