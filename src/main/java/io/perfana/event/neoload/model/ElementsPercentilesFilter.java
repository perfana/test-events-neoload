...
/**
 * A filter for querying the Elements Percentiles endpoint
 */

@Schema(name = "ElementsPercentilesFilter", description = "A filter for querying the Elements Percentiles endpoint")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2024-04-06T15:29:22.895694+02:00[Europe/Amsterdam]", comments = "Generator version: 7.4.0")
public class ElementsPercentilesFilter implements DashboardFilter {
  ...
  public enum TypeEnum {
    ELEMENTS_PERCENTILES("ELEMENTS_PERCENTILES");
  ...
  public ElementsPercentilesFilter() {
    super();
  }
   ...
   */
  public ElementsPercentilesFilter(String elementId, TypeEnum type) {
    this.elementId = elementId;
    this.type = type;
  }

  public ElementsPercentilesFilter elementId(String elementId) {
    this.elementId = elementId;
    return this;
  }
  ...
  */
  ...
  public ElementsPercentilesFilter type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public ElementsPercentilesFilter userPathId(String userPathId) {
  ...
  */
  ...
  @Schema(name = "userPathId", example = "123e4567-e89b-12d3-a456-426655440000", description = "ID", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public boolean equals(Object o) {
    ...
    ElementsPercentilesFilter elementsPercentilesFilter = (ElementsPercentilesFilter) o;
    return Objects.equals(this.elementId, elementsPercentilesFilter.elementId) &&
        Objects.equals(this.type, elementsPercentilesFilter.type) &&
        Objects.equals(this.userPathId, elementsPercentilesFilter.userPathId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ElementsPercentilesFilter {\n");
