...
/**
 * Test Result Timeseries fields
 */

@Schema(name = "ResultTimeseries", description = "Test Result Timeseries fields")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2024-04-06T15:29:22.895694+02:00[Europe/Amsterdam]", comments = "Generator version: 7.4.0")
public class ResultTimeseries {

  @Valid
  private List<@Valid Point> points = new ArrayList<>();
   ...
   */
  public ResultTimeseries(List<@Valid Point> points, String samplingInterval) {
    this.points = points;
    this.samplingInterval = samplingInterval;
  }

  public ResultTimeseries points(List<@Valid Point> points) {
    this.points = points;
    return this;
  }

  public ResultTimeseries addPointsItem(Point pointsItem) {
    if (this.points == null) {
  ...
  */
  ...
  @JsonProperty("points")
  public List<@Valid Point> getPoints() {
    return points;
  }

  public void setPoints(List<@Valid Point> points) {
    this.points = points;
  }

  public ResultTimeseries samplingInterval(String samplingInterval) {
    this.samplingInterval = samplingInterval;
    return this;
  }
  ...
  */
  ...
  public ResultTimeseries isFromScratch(Boolean isFromScratch) {
  ...
  */
  ...
  public ResultTimeseries nextRequestToken(String nextRequestToken) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    ResultTimeseries resultTimeseries = (ResultTimeseries) o;
    return Objects.equals(this.points, resultTimeseries.points) &&
        Objects.equals(this.samplingInterval, resultTimeseries.samplingInterval) &&
        Objects.equals(this.isFromScratch, resultTimeseries.isFromScratch) &&
        Objects.equals(this.nextRequestToken, resultTimeseries.nextRequestToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResultTimeseries {\n");
