...
/**
 * Represents a user page.
 */

@Schema(name = "UserPage", description = "Represents a user page.")
...
public class UserPage {
   ...
   */
  public UserPage(List<@Valid User> items, Long total) {
    this.items = items;
    this.total = total;
  }

  public UserPage items(List<@Valid User> items) {
    this.items = items;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, userPage.items) &&
