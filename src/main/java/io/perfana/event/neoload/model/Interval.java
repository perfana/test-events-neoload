...
public class Interval {
   ...
   */
  public Interval(String id, String endOffset, String name, String startOffset) {
    this.id = id;
  ...
  */
  ...
  @Schema(name = "id", example = "123e4567-e89b-12d3-a456-426655440000", description = "Unique ID of the Interval.", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("id")
  public String getId() {
    return id;
  }
  ...
  public Interval endOffset(String endOffset) {
    this.endOffset = endOffset;
    return this;
  }
  ...
  */
  ...
  public Interval name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  ...
  public Interval startOffset(String startOffset) {
    this.startOffset = startOffset;
    return this;
  }
  ...
  */
  ...
  public Interval color(String color) {
    this.color = color;
    return this;
  }
  ...
  */
  ...
  public Interval description(String description) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, interval.id) &&
        Objects.equals(this.endOffset, interval.endOffset) &&
        Objects.equals(this.name, interval.name) &&
        Objects.equals(this.startOffset, interval.startOffset) &&
        Objects.equals(this.color, interval.color) &&
        Objects.equals(this.description, interval.description);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, endOffset, name, startOffset, color, description);
  }
